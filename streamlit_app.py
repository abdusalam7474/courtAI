...
with col1:
    ...
    user_input[0]["Offense Date"] = st.date_input("Offense Date", value=(preset["Offense Date"]).iloc[0], format="DD/MM/YY")
with col2:
    user_input[0]["Gender"] = st.selectbox("Gender", gender_opts)
    user_input[0]["Age"] = st.number_input("Age", value=(preset["Age"]).iloc[0])
    user_input[0]["Sentence Date"] = st.date_input("Sentence Date", value=(preset["Sentence Date"]).iloc[0], format="DD/MM/YY")
...
with col3:
    ...
    user_input[0]["Release Date"] = st.date_input("Release Date", value=(preset["Release Date"]).iloc[0], format="DD/MM/YY")
