...
amount_opts = [None, "less than 1,500", "less than 2,500", "greater than or equal to 2,500, less than 30K", "greater than or equal to 20K less than 100k", "greater than 200k", "greater than or equal to 30K, less than 150k", "greater than or equal to 1,500, less than 20K", "less than 20K"]
...
with col4:
    enhance = st.selectbox("Enhancement (if any):", [None, "ENH IAT"])
description_parts = [theft_or_larcency, amount, prev_conv, enhance]
description_parts = [item for item in description_parts if item is not None]
...
if predict_button:
    ...
    user_input_df["Offense"] = encds["Offense_encoder"].fit_transform(user_input_df["Offense"])
